...
var (
	...
	ErrIndexOutOfRange = errors.New("index out of index")
...
// LRange returns the specified elements of the list stored key
// [start, end]
...
// count < 0: Remove elements equal to value moving form tail to head
