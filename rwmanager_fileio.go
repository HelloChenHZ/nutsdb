...
// NewFileIORWManager return a newly initialized FileIORWManager
...
// On files that support SetDeadline, and pending I/O operations will
// be canceled and return immediately with error
